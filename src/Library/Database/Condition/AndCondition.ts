...
export default class AndCondition implements ICondition {
	...
	public toString() {
		...
		str += this.left instanceof OrCondition ? `(${leftString})` : leftString;
		str += " AND ";
		str += this.right instanceof OrCondition ? `(${rightString})` : rightString;
